...
%________________________________________________
% Guia de tallas
guia_tallas(unitalla, para_cualquier_tipo_de_talla).
guia_tallas(m,__51cm_a_52cm).
guia_tallas(l,__53cm_a_56cm).
guia_tallas(xl,__57cm_a_58cm).
guia_tallas(xxl, __para_cualquier_tipo_de_talla).
guia_tallas(nino, __para_cualquier_tipo_de_talla).
